...
declare_id!("BY25Ys3BudKhFnaGbTCfQBsbpnogoHACzcN5ZWNDvFWR");
...
pub mod token_lottery {
    ...
    pub fn claim_winnings(ctx: Context<ClaimWinnings>) -> Result<()> {
        ...
        require!(ctx.accounts.ticket_account.amount > 0, ErrorCode::IncorrectTicket);
...
pub struct ClaimWinnings<'info> {
    ...
    pub winnning_collection_metadata: Account<'info, MetadataAccount>,
...
pub struct InitializeLottery<'info> {
    ...
    /// CHECK: This account is checked by the metadata smart account
